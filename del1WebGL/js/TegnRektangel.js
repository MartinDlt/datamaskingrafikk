...
function main() {
	...
	gl.vertexAttrib4f(a_Position, 0.2, 0.53, 0.0, 1.0);
	// Punktet vises ikke om x/y er større enn 1 eller mindre enn -1, ettersin dette er sidekantene på lerretet
	gl.vertexAttrib1f(a_PointSize, 20.0);

	// Set the color for clearing <canvas>
	gl.clearColor(1.0, 1.0, 0.4, 1.0);
	// Clear <canvas>
